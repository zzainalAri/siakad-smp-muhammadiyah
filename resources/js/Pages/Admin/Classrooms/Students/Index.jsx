...
import hasAnyPermissions, { deleteAction, flashMessage } from '@/lib/utils';
    ...
    return (
        <>
            <div className="flex w-full flex-col pb-32">
                ...
                <Card>
                    {hasAnyPermissions(props.auth.permissions, ['classrooms.assign-student']) && (
                    ...
                    <CardContent
                        className={
                            !hasAnyPermissions(props.auth.permissions, ['classrooms.assign-student']) ? 'pt-10' : ''
                        }
                    >
                            ...
                            <>
                                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                                    {Array.from({ length: 20 }).map((_, index) => {
                                        ...
                                        if (student) {
                                            const studentCard = (
                                                <Button size="xl" variant="blue" className="p-16" key={index}>
                                            ...
                                            return hasAnyPermissions(props.auth.permissions, [
