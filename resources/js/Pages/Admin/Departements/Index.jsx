                                ...
                                <TableBody>
                                    {departements.map((departement, index) => (
                                        <TableRow key={index}>
                                            ...
                                            <TableCell>
                                                <Avatar>
                                                    <AvatarImage src={departement.logo} />
                                                    <AvatarFallback>{departement.name.substring(0, 1)}</AvatarFallback>
                                                </Avatar>
                                            </TableCell>
                                            ...
                                            <TableCell>
                                                <div className="flex items-center gap-x-1">
                                                    ...
                                                    <AlertAction
                                                        ...
                                                        action={() =>
                                                            deleteAction(
                                                                route('admin.departements.destroy', [departement]),
                                                            )
                                                        }
                                                    />
                                                </div>
